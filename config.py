...
class Config:
    ...
    def _add_themes(self):
        ...
        green = Theme((223, 235, 200), (119, 154, 88), (244, 247, 116), (172, 195, 51), '#C86464', '#C84646')
        ...
        cool = Theme((225,225,225), (49,73,65), (244, 247, 116), (172, 195, 51), '#C86464', '#C84646')

        self.themes = [cool, green, brown, blue]